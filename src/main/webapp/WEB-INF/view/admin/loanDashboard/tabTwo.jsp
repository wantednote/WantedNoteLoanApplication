                       ...
                       <div class="ibox-content" style="display: block;">
                           <form role="form" class="form-inline">
                               ...
                               <c:if test="${not empty distributers}">
                                <div class="form-group">
                                    <select id="distributerList1" name="distributer1[]" multiple class="form-control" >
                               ...
                               <div class="form-group pull-right">
                               	<button style="border-radius: 0px;" type="button" class="btn btn-primary" onclick="getRefereshData1();"><i class="fa fa-refresh"></i> Search</button>
                               </div>
                               <!-- <div class="form-group pull-right">
